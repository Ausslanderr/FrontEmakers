...
function Navbar(){
    // jsx javascript xml
    return <nav className="navbar navbar-expand-lg bg-body-tertiary py-3">
  <div className="container-fluid">
    <a href="../login-signup/login.html" className="navbar-brand" >GameDame</a>
      ...
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item dropdown">
          ...
          <ul className="dropdown-menu">
            <li><a className="dropdown-item" href="#">Indie</a></li>
